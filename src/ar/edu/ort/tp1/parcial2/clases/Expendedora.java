...
/*	En este momento si pos es menor que el size significa que SI o SI encontrÛ.
 * 	Porque si fuera igual (o sea no menor) serÌa que la cant. de iteraciones 
 * 	llegÛ a ser igual a size(). Y size tiene la cant. de elementos, PERO los elementos
 * 	se identifican desde el cero */		
